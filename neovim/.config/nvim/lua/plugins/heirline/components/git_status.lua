...
return {
...

    {
        provider = function(self)
            ...
            return count > 0 and (git_icons.add .. self.status.added .. " ")
        end,
        hl = { fg = colors.green },
    },
    {
        provider = function(self)
            ...
            return count > 0 and (git_icons.change .. self.status.changed .. " ")
        end,
        hl = { fg = colors.orange },
    },
    {
        provider = function(self)
            ...
            return count > 0 and (git_icons.delete .. self.status.removed .. " ")
        end,
        hl = { fg = colors.red },
    },
}
